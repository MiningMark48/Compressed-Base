...
public class BlockCompressedBaseExtension extends ModBaseBlock {
    ...
    public void addInformation(ItemStack par1ItemStack, @Nullable World world, List par3List, ITooltipFlag par4) {
        par3List.add(TextFormatting.GREEN + ModTranslate.toLocal("tooltip.block.compressed_base_extension.line1"));
    }
